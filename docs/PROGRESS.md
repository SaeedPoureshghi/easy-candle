...
- **Last done session:** `05`
- **Next session to implement:** `06` _(awaiting merge)_
- **Active branch:** `session/06-replay-store-sync`
...
| 06 | Store, clock, chart sync | 3 | `session/06-replay-store-sync` | `implemented` | no | Engine in store + clock + setData/update sync |
