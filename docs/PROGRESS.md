...
- **Last done session:** `03`
- **Next session to implement:** `04` _(implemented on branch; awaiting merge)_
- **Active branch:** `session/04-real-chart-data`
...
| 04 | Real data on chart | 2 | `session/04-real-chart-data` | `implemented` | no | Live BTCUSDT via store + selectors |
