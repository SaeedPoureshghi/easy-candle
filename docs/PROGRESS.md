...
- **Last done session:** `01`
- **Next session to implement:** `02` _(implemented on branch; awaiting merge)_
- **Active branch:** `session/02-static-chart`
...
| 02 | Static chart shell | 1 | `session/02-static-chart` | `implemented` | no | Mock candles via lightweight-charts v4 |
